 ...
 *
 */
public class SMTExistsStatement implements SMTFact {
	...
	public SMTExistsStatement(SMTBoundedVar boundedVar, SMTDataType dataType, SMTFact content) {
	...
	public SMTExistsStatement(List<SMTBoundedVar> boundedVars, List<SMTDataType> dataTypes, SMTFact content) {
		this.boundedVars = boundedVars;
		this.dataTypes = dataTypes;
		this.content = content;
	}
	
	public SMTExistsStatement(List<SMTBoundedVar> boundedVars, List<SMTDataType> dataTypes, SMTFact content, boolean explicit) {
		this.boundedVars = boundedVars;
		this.dataTypes = dataTypes;
		this.content = content;
	...
	private SMTBitVecComparisonStatement boundedVarIsInBounds(SMTBoundedVar boundedVar, SMTDataType dataType, SMTSynthesisEngine synthesisEngine) {
		return new SMTBitVecComparisonStatement(SMTBitVectorOp.LESS_THAN, boundedVar, new SMTBitVec(dataType, synthesisEngine.getAutomatonSize(dataType)));
	}
}
