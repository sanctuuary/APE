 ...
 *
 */
public class SMTBinaryPredicate implements SMTPredicate {
...
//	}
	...
	public SMTBinaryPredicate(SMTFunctionName predicate, SMTFunctionArgument argument1, SMTFunctionArgument argument2) {
		super();
		this.predicate = predicate;
