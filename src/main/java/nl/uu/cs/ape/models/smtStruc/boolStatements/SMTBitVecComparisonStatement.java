 ...
 *
 */
public class SMTBitVecComparisonStatement implements SMTFact {
	...
	public SMTBitVecComparisonStatement(SMTFact arg1, SMTFact arg2) {
		super();
	}


	public SMTBitVecComparisonStatement(SMTBitVectorOp operation, SMTBoundedVar boundedVar, SMTBitVec bitVecNumber) {
