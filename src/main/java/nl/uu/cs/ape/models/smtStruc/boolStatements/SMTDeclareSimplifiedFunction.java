 ...
 *
 */
public class SMTDeclareSimplifiedFunction implements SMTLib2Row {
	...
	public SMTDeclareSimplifiedFunction(AtomType predicate, int orderNumber, SMTDataType dataTypeName, SMTDataType automatonType) {
