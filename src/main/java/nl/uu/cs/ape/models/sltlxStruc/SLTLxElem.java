...
public interface SLTLxElem {
	...
	/**
	 * Create the CNF encoding of the statement and return the string representation.
	 * 
	...
	/**
	 * CreatE the CNF encoding of the negation of the statement and return the string representation.
	 * 
	 * @param synthesisEngine - synthesis engine used to encode the problem.
