...
/**
 * Class represents an auxiliary predicates (module or type) that represents a
 * collection of disjoint or conjunct predicates.
 * 
...
public interface AuxiliaryPredicate extends Predicate {
     ...
     /**
      * Return the list of {@link TaxonomyPredicate}s that are generalized over using
