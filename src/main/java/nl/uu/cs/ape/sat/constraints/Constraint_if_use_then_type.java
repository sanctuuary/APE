 ...
 *
 */
public class Constraint_if_use_then_type extends Constraint {
	...
	public String getConstraint(String[] parameters, AllModules allModules, AllTypes allTypes, ModuleAutomaton moduleAutomaton,
		...
		constraint = SLTL_formula.ite_type(if_type, then_type, moduleAutomaton, typeAutomaton.getUsedTypesBlocks(), mappings);
