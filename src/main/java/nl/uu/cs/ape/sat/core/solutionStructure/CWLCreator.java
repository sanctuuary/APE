...
public class CWLCreator {
     ...
     */
    public CWLCreator setIndentStyle(IndentStyle indentStyle) {
     ...
     * (Default label: "APE generated workflow.")
     * @param label The label to use.
     * @return A reference to this CWLCreator.
     */
    public CWLCreator setLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    private void generateCWLRepresentation() {
        ...
        cwlRepresentation.append("label: ").append(label).append("\n");
        generateDoc();
