...
public class CWLCreator {
    /** CWL version 1.2.0-dev2 is the minimum version required for the features we use. */
    private static final String cwlVersion = "v1.2.0-dev2";

    private final SolutionWorkflow solution;
    private final StringBuilder cwlRepresentation;
     ...
     * Uses 2 spaces as indentation.
     * @param solution The solution to represent in CWL.
     */
    public CWLCreator(SolutionWorkflow solution) {
        this(solution, IndentStyle.SPACES2);
    }

    /**
     * Instantiates a new CWL creator.
     * @param solution The solution to represent in CWL.
     * @param indentStyle The indentation style to use when generating the CWL file.
     */
    public CWLCreator(SolutionWorkflow solution, IndentStyle indentStyle) {
     ...
     */
    private void generateCWLRepresentation() {
     ...
     */
    private void deleteLastCharacters(int number) {
