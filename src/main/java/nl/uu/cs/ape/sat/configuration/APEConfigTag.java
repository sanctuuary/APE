...
/**
 * This field info should be instantiated as static containers
 * to provide information about the configuration tags.
 *
 * @param <T> The type of the required field.
 */
public abstract class APEConfigTag<T> {
    ...
    public APEConfigField<T> createField(){
        return new APEConfigField<T>(this);
    }
    ...
    public JSONObject toJSON() {
        ...
        JSONObject obj = new JSONObject()
                ...
                .put("type", getType().getSimpleName())
    ...
    /**
     * If the field had a default value, this field is optional.
     *
     * @return the boolean
     */
