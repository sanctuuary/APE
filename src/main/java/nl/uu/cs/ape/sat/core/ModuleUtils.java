...
public abstract class ModuleUtils {
	...
	public String encodeDataInstanceDependencyCons(TypeAutomaton typeAutomaton, AtomMappings mappings) {
		StringBuilder constraints = new StringBuilder();
	 ...
	 * @return String representation of constraints.
	 */
	public abstract String allowDataDependencyCons(TypeAutomaton typeAutomaton, AtomMappings mappings);
	 ...
	 * @return String representation of constraints.
	 */
	public abstract String enforceDataDependencyOverDataReferencing(TypeAutomaton typeAutomaton, AtomMappings mappings);

	public abstract String enforceDataDependencyOverModules(TypeAutomaton typeAutomaton, AtomMappings mappings);
