...
public class main {
	...
	private static boolean customConfigSetup(String newConfigFile) {
		try {
			...
			PILEPINE = StaticFunctions.isValidConfigBoolean(PILEPINE_TAG,
					newConfig.getString(PILEPINE_TAG));
			if (PILEPINE == null) {
				return false;
			} else {
